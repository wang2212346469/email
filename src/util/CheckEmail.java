    ...
    public static void checkEmail(List<String> emails) {
        ...
        for (int i=710;i<emails.size();i++ ) {
            ...
            try {
                ...
                if (msg.contains("250")) {
                    FileUtil.appendStringToFile(EmailUtils.absoutPath+"\\"+"src\\couldSendEmail.txt",emails.get(i)+"\r\n");
                } else {
                    FileUtil.appendStringToFile(EmailUtils.absoutPath+"\\"+"src\\couldNotSendEmail.txt",emails.get(i)+"\r\n");
                }
                ...
                try {
                    FileUtil.appendStringToFile(EmailUtils.absoutPath+"\\"+"src\\Timeout.txt",emails.get(i)+"\r\n");
                ...
                try {
                    FileUtil.appendStringToFile("src\\couldNotSendEmail.txt",emails.get(i)+"\r\n");
                } catch (IOException e1) {
                    System.out.println("exception:"+e.getMessage());
                }
